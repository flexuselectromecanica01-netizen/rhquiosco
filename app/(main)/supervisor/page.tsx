...
import { CalendarCheck, Users, CalendarDays, Clock } from "lucide-react";
    ...
    <main className="bg-gray-100 px-6 py-10">
      <section className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div
            aria-disabled="true"
            className="cursor-not-allowed bg-gray-100 rounded-2xl shadow-sm p-8 flex flex-col items-center justify-center text-center border border-gray-200 opacity-60"
          >
            <Clock
              size={48}
